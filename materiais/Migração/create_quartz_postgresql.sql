...
ALTER TABLE qrtz5_job_listeners OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_trigger_listeners OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_fired_triggers OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_paused_trigger_grps OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_scheduler_state OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_locks OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_simple_triggers OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_cron_triggers OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_blob_triggers OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_triggers OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_job_details OWNER TO pentaho_rodox;
ALTER TABLE qrtz5_calendars OWNER TO pentaho_rodox;